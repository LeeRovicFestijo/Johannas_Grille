...
const AdminReservationMenuList = ({ id, name, price, description, image, category }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch('https://localhost/api/reservationmenuitems'); // Adjust this to your API URL
    ...
    const fetchMenuItems = async () => {
        try {
            const response = await fetch('https://localhost/api/reservationmenuitems');
            if (response.ok) {
                const data = await response.json();
                setMenuItems(data);
