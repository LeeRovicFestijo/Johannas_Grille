...
const InventoryCategory = ({ category, setCategory }) => {
    ...
    return (
      <div className="admin-inv-product-menu">
        ...
        {showPopup && (
          <div className="admin-inv-popup-form">
            <div className="admin-inv-popup-content">
              <h2>Add New Product</h2>
              <form onSubmit={handleFormSubmit}>
                <input
                  type="text"
                  placeholder="Enter product name and portion"
                  className="admin-inv-popup-input"
                  value={productName}
                ...
                <div className="admin-inv-popup-actions">
                  <button type="submit" className="admin-inv-popup-button submit">Submit</button>
                  <button type="button" className="admin-inv-popup-button cancel" onClick={() => setShowPopup(false)}>Cancel</button>
                </div>
              </form>
            </div>
          </div>
